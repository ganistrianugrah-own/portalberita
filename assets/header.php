...
<nav class="navbar navbar-expand-lg navbar-dark gradient-header fixed-top shadow">
  <div class="container-fluid d-flex align-items-center">
    ...
    <a class="navbar-brand d-flex align-items-center" href="/portal-berita/public/index.php">
...
<div class="collapse navbar-collapse" id="navbarNav">
  <ul class="navbar-nav ms-auto">
    <li class="nav-item">
      <a class="nav-link <?= $currentPage == 'index.php' ? 'active' : '' ?>" href="/portal-berita/public/index.php">Beranda</a>
    </li>
    <li class="nav-item">
      <a class="nav-link <?= $currentPage == 'news.php' ? 'active' : '' ?>" href="news.php">News</a>
    </li>
    <li class="nav-item">
      <a class="nav-link <?= $currentPage == 'jadwal_dokter.php' ? 'active' : '' ?>" href="/portal-berita/public/dokter/jadwal_dokter.php">Jadwal Dokter</a>
    </li>
    <li class="nav-item">
      <a class="nav-link <?= $currentPage == 'tentang.php' ? 'active' : '' ?>" href="tentang.php">Tentang</a>
    </li>
    <li class="nav-item">
      <a class="nav-link <?= $currentPage == 'kontak.php' ? 'active' : '' ?>" href="kontak.php">Kontak</a>
    </li>
  </ul>
</div>
